...
/**
 * Parses a config client bean definition:<br/>
 * <code>&lt;config:configuration id="configuration" source="xmlConfiguration"/&gt;</code>
 *  <br/>
 *  It assumes a bean called 'xmlconfiguration' exists.
 *  
...
public class ConfigurationBeanDefinitionParser extends AbstractSingleBeanDefinitionParser
{
    ...
    {
        return MaduraConfiguration.class;
    }
